...
def main(argv):
    ...
    X_train2, y_train2, X_test2, y_test2 = create_client(argv[1])
    ...
    # print(len(x_train))
    # r = model.fit(yy, yy_train, validation_data=(x_test, y_test), epochs=30)
    ...
    # Fit
    r = model.fit(yy, yy_train, validation_data=(x_test, y_test), epochs=EPOCHES)
    # model.evaluate(x_test, y_test)
    model.save_weights('/home/narisu/src/TFF/Model/' + argv[1] + '.h5')
